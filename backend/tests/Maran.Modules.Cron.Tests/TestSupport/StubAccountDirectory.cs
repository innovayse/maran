...
/// anything it was not given, which is exactly how the real implementation answers for an account in
/// another tenant — so a test can drive that path without standing up the Accounts module.
/// </summary>
/// <remarks>
/// It carries more weight here than in the modules that keep rows. Their tenant boundary is a query
/// filter and this is merely how they learn a user name; in this module the resolution IS the
/// boundary, so every IDOR test in the project is a test of what this double answers null to.
/// </remarks>

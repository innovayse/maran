...
/// <summary>
/// An <see cref="IMessageBus"/> double that records what the module PUBLISHED. The scheduled backup
/// sweep asks for retention and waits for nothing, so a test needs one behaviour from the bus: keep

...
namespace Maran.Modules.Sites.Tests.Common;

/// <summary>
/// Behavioral contract of <see cref="SiteDescriptorFactory"/>: every field of the descriptor comes
...
/// </remarks>
public sealed class SiteDescriptorFactoryTests
{
    ...
    public void An_installed_certificate_is_carried_into_the_descriptor()
    {
        ...
        var descriptor = SiteDescriptorFactory.From(site);
    ...
    public void A_site_with_no_certificate_is_described_as_having_none()
    {
        ...
        var descriptor = SiteDescriptorFactory.From(PhpSite());

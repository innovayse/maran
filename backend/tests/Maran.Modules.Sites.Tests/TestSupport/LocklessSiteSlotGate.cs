...
/// by <c>Maran.Host.IntegrationTests.SiteLimitRaceTests</c>.
/// </para>
/// </remarks>
public sealed class LocklessSiteSlotGate : ISiteSlotGate
{
    ...
    public LocklessSiteSlotGate(SitesDbContext dbContext)
    {

...
public static class ExpectedErrorStatuses
{
    ...
    public static readonly IReadOnlyDictionary<string, ErrorType> Kinds =
        new Dictionary<string, ErrorType>(StringComparer.Ordinal)
        {
            ...
            ["AccountLoginIssuanceFailed"] = ErrorType.Failure,
            ["AccountNameTaken"] = ErrorType.Conflict,
            ["AccountNotFound"] = ErrorType.NotFound,
            ["AccountResumptionFailed"] = ErrorType.Failure,
            ["AccountResumptionNotObserved"] = ErrorType.Failure,
            ["AccountSuspensionFailed"] = ErrorType.Failure,
            ["AccountSuspensionNotObserved"] = ErrorType.Failure,
            ...
            ["AgentLimitReached"] = ErrorType.Conflict,
            ["AgentNotFound"] = ErrorType.NotFound,
            ["AgentNotImplemented"] = ErrorType.Failure,
            ["AgentSystemFailure"] = ErrorType.Failure,
            ["AgentUnspecified"] = ErrorType.Failure,
            ["AgentValidationFailed"] = ErrorType.Validation,
            // The four endings a create stream can have that name no artifact. They are recorded on
            // the backup row as its failure code and are classified here for the same reason every
            // other code is: they are user-facing text, and the census refuses an unclassified one.
            // Dropped and Idle are Unavailable — the agent stopped answering, which is a retry;
            // Truncated and Cancelled are Failure — the run ended and produced nothing.
            ["BackupArtifactUnvouched"] = ErrorType.Failure,
            ["BackupCancelled"] = ErrorType.Failure,
            ["BackupInvalidOutcome"] = ErrorType.Failure,
            ["BackupNotFound"] = ErrorType.NotFound,
            ["BackupOutcomeUnobserved"] = ErrorType.Failure,
            ["BackupStillRunning"] = ErrorType.Conflict,
            ["BackupStreamDropped"] = ErrorType.Unavailable,
            ["BackupStreamIdle"] = ErrorType.Unavailable,
            ["BackupNotRestorable"] = ErrorType.Conflict,
            // The schedule form's four refusals are Validation — a field outside its range or a
            // weekday paired with the wrong frequency is a malformed request, not a server fault.
            // NotFound is the honest answer for a server that has never configured a schedule, and
            // the aborted run is a Failure: the sweep started and produced nothing.
            ["BackupScheduleDayNotAllowed"] = ErrorType.Validation,
            ["BackupScheduleDayRequired"] = ErrorType.Validation,
            ["BackupScheduleHourOutOfRange"] = ErrorType.Validation,
            ["BackupScheduleNotFound"] = ErrorType.NotFound,
            ["BackupDestinationNotFound"] = ErrorType.NotFound,
            ["BackupDestinationNotConfigured"] = ErrorType.Failure,
            ["BackupDestinationRemoteUnsupported"] = ErrorType.Validation,
            ["BackupDestinationLocalAlreadyDefined"] = ErrorType.Conflict,
            ["BackupDestinationNameInvalid"] = ErrorType.Validation,
            ["BackupScheduleRetainOutOfRange"] = ErrorType.Validation,
            ["BackupScheduledRunAborted"] = ErrorType.Failure,
            ["BackupTruncated"] = ErrorType.Failure,
            ...
            ["CronEntryLimitReachedConcurrently"] = ErrorType.Conflict,
            ...
            ["FinalBackupFailed"] = ErrorType.Failure,
            ["FtpUserLimitReached"] = ErrorType.Conflict,
            ["FtpUserLimitReachedConcurrently"] = ErrorType.Conflict,
            ["FtpUserNameInvalidFormat"] = ErrorType.Validation,
            ["FtpUserNameTaken"] = ErrorType.Conflict,
            ["FtpUserNameTooLong"] = ErrorType.Validation,
            ["FtpUserNotFound"] = ErrorType.NotFound,
            ["FtpUserProvisioningFailed"] = ErrorType.Failure,
            ["FtpsCertificateMissing"] = ErrorType.Failure,
            ["FtpsHostnameInvalidFormat"] = ErrorType.Validation,
            ["FtpsHostnameNotServed"] = ErrorType.Validation,
            ["FtpsHostnameTooLong"] = ErrorType.Validation,
            ["FtpsPassiveAddressInvalid"] = ErrorType.Validation,
            ["HostValidationFailed"] = ErrorType.Validation,
            ["InvalidCredentialsUnauthorized"] = ErrorType.Unauthorized,
            ["InvitationAccountNotFound"] = ErrorType.NotFound,
            ["InvitationLoginNotPending"] = ErrorType.Conflict,
            ["InvitationTokenInvalid"] = ErrorType.Validation,
            ["LicenceInstallTextRequired"] = ErrorType.Validation,
            ["LicenceInstallMalformed"] = ErrorType.Validation,
            ["LicenceInstallSignatureInvalid"] = ErrorType.Validation,
            ["LicenceInstallExpired"] = ErrorType.Validation,
            ["LicenceInstallProductMismatch"] = ErrorType.Validation,
            ["LicenceInstallFingerprintMismatch"] = ErrorType.Validation,
            ...
            ["RestoreArtifactRejected"] = ErrorType.Validation,
            ["RestoreCancelled"] = ErrorType.Failure,
            ["RestoreConfirmationMismatch"] = ErrorType.Conflict,
            ["RestoreConfirmationRequired"] = ErrorType.Validation,
            ["RestoreInvalidOutcome"] = ErrorType.Failure,
            ["RestorePartial"] = ErrorType.Failure,
            ["RestoreOutcomeUnobserved"] = ErrorType.Failure,
            ["RestoreStreamDropped"] = ErrorType.Unavailable,
            ["RestoreStreamIdle"] = ErrorType.Unavailable,
            ["RestoreTruncated"] = ErrorType.Failure,
            ["RulePortInvalid"] = ErrorType.Validation,
            ["RulePortRangeInvalid"] = ErrorType.Validation,
            ...
            ["SetupTokenExpiredUnauthorized"] = ErrorType.Unauthorized,
            ["SetupTokenInvalidUnauthorized"] = ErrorType.Unauthorized,
            ["SftpUserLimitReached"] = ErrorType.Conflict,
            ["SftpUserLimitReachedConcurrently"] = ErrorType.Conflict,
            ...
            ["SiteLimitReachedConcurrently"] = ErrorType.Conflict,

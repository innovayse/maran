...
/// by <c>Maran.Host.IntegrationTests.FtpUserLimitRaceTests</c>.
/// </para>
/// </remarks>
public sealed class LocklessFtpUserSlotGate : IFtpUserSlotGate
{
    ...
    public LocklessFtpUserSlotGate(FtpDbContext dbContext)
    {

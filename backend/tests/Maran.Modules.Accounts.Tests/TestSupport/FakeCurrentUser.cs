...
/// <summary>
/// An <see cref="ICurrentUser"/> double, so a test can BE a particular tenant. The account
/// directory's tenant scope closes over this, which is the subject of its isolation tests.
/// </summary>

...
/// </summary>
/// <remarks>
/// An EF Core interceptor rather than a subclassed context, because <c>DatabasesDbContext</c> is
...
/// being reproduced: the agent has created the database and the panel's row does not exist.
/// </remarks>

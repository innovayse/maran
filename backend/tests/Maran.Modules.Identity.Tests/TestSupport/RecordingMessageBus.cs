...
/// <summary>
/// An <see cref="IMessageBus"/> double that records what the module PUBLISHED. The brute-force
/// detector announces a detection and waits for nothing, so a test needs exactly one behaviour from
/// the bus: keep what was published, in order. Every other member is unreachable from the code under
/// test and says so rather than pretending.
/// </summary>

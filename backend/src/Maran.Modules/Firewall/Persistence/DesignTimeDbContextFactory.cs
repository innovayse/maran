...
/// construct <see cref="FirewallDbContext"/> without booting the Host. Never used at runtime — the
...
/// string here silently wins over the developer's real settings. The settings are therefore read
...
/// </remarks>
public sealed class DesignTimeDbContextFactory : IDesignTimeDbContextFactory<FirewallDbContext>
{
    ...
    public FirewallDbContext CreateDbContext(string[] args)
    {
        ...
        return new FirewallDbContext(optionsBuilder.Options);
    }

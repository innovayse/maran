...
/// construct <see cref="MonitoringDbContext"/> without booting the Host. Never used at runtime — the
...
/// </remarks>
public sealed class DesignTimeDbContextFactory : IDesignTimeDbContextFactory<MonitoringDbContext>
{

...
/// construct <see cref="TasksDbContext"/> without booting the Host. Never used at runtime — the
...
public sealed class DesignTimeDbContextFactory : IDesignTimeDbContextFactory<TasksDbContext>
{
    ...
    public TasksDbContext CreateDbContext(string[] args)
    {
        ...
        return new TasksDbContext(optionsBuilder.Options, new DesignTimeCurrentUser());
    }

...
/// construct <see cref="SitesDbContext"/> without booting the Host. Never used at runtime — the
...
/// </remarks>
public sealed class DesignTimeDbContextFactory : IDesignTimeDbContextFactory<SitesDbContext>
{
    ...
    public SitesDbContext CreateDbContext(string[] args)
    {
        ...
        return new SitesDbContext(optionsBuilder.Options, new DesignTimeCurrentUser());
    }

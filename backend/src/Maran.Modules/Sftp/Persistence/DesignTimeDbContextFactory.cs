...
/// construct <see cref="SftpDbContext"/> without booting the Host. Never used at runtime — the
...
/// </remarks>
public sealed class DesignTimeDbContextFactory : IDesignTimeDbContextFactory<SftpDbContext>
{
    ...
    public SftpDbContext CreateDbContext(string[] args)
    {
        ...
        return new SftpDbContext(optionsBuilder.Options, new DesignTimeCurrentUser());
    }

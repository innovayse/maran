...
/// construct <see cref="NotificationsDbContext"/> without booting the Host. Never used at runtime — the
...
public sealed class DesignTimeDbContextFactory : IDesignTimeDbContextFactory<NotificationsDbContext>
{
    ...
    public NotificationsDbContext CreateDbContext(string[] args)
    {
        ...
        return new NotificationsDbContext(optionsBuilder.Options, new DesignTimeEncryptionService());
    }

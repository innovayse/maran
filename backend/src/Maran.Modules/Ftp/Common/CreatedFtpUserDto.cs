...
/// <summary>
/// The one and only answer that carries a new login's password: what creating it produced, including
/// the credential the customer will never be shown again.
/// </summary>
/// <remarks>
/// <para>
/// A separate type from <see cref="FtpUserDto"/> precisely so that "the response with the password
...
/// </para>
/// </remarks>
/// <param name="Id">The new login's identity.</param>
...
/// <param name="FullName">The system login the host holds — what the customer signs in with.</param>
/// <param name="Protocol">Which daemon accepts it, as the backend spells it.</param>
/// <param name="Password">
...
public sealed record CreatedFtpUserDto(
    Guid Id,
    Guid AccountId,
    string Name,
    string FullName,

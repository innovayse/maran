...
- Fresh implementer per task with a brief; adversarial review told to attack; every ruling recorded in the mutation ledger, kept only as a working file, not committed.

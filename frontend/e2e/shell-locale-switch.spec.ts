 ...
 */
const localeTrigger = (page: Page): Locator => page.getByRole('banner').locator('[aria-haspopup="menu"]')
...
test('requests carry the chosen locale in Accept-Language so server text matches the interface', async ({ page }) => {

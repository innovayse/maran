...
const props = withDefaults(
  ...
  { align: 'start', disabled: false, ariaLabel: undefined, chevron: true },
)
...
<template>
  <div ref="rootElement" class="relative inline-block" @focusout="onFocusOut">
    <button
      :id="triggerId"
      ref="triggerElement"
      type="button"
    ...
    <ul
      ...
      class="absolute z-10 mt-1 min-w-48 rounded-lg border border-border-strong bg-surface-2 p-1 shadow-[0_12px_32px_rgb(0_0_0/0.4)]"
